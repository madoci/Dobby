...
$(BIN_DIR)/dobby-load-elf-file:                $(OBJ_DIR)/fread.o $(OBJ_DIR)/util.o $(OBJ_DIR)/elf_header.o $(OBJ_DIR)/elf_section_table.o $(OBJ_DIR)/elf_section_content.o $(OBJ_DIR)/elf_file.o $(OBJ_DIR)/elf_load_section.o
